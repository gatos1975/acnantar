...
<form
    ...
    <div class="input-group">
        ...
        <div align="center" class="input-group-append">
            ...
            <h4 >CAJA DE AHORROS Y CREDITOS "NANTAR"</h4>
        </div>
    </div>
</form>
...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php error_reporting(0); echo $_SESSION['Nombres'] . ' ' . $_SESSION['Apellidos']?></span>
